...
public class FlyweightTest extends Graphics {

	private static final int Top = 0;
	private static final int Left = 0;
	private static final int HSpace = 0;
	private static final int HCount = 0;
	...
	public static void main(String[] args) {
		...
		FlyweightTest flyweitgh = new FlyweightTest();
		flyweitgh.paint(flyweitgh);
	...
	FolderFactory fact = new FolderFactory();
